...
public class ListProcessorActualTest {
	...
	public void testSearchByHashtag4() {
		...
		tasks.addAll(taskBuilder
				.createTask("ask KaiYao CS2103 project questions"));
		assertEquals(listProcessor.searchByHashtag(tasks, "KaiYao").size(), 1);
		assertEquals(listProcessor.searchByHashtag(tasks, "KaiYao").get(0),
				tasks.get(1));
	}
	...
	public void testSearchByKeyword4() {
		...
		assertEquals(listProcessor.searchByKeyword(tasks, "KaiYao").get(0),
				tasks.get(1));
		assertEquals(listProcessor.searchByKeyword(tasks, "KaiYao").get(1),
				tasks.get(2));
	}
